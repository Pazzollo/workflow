...
@section('content')
        ...
        <main class="d-flex" id="main">
            ...
            <x-sidebar id="sidebar" :links="['NeštoDrugo' => '#', 'NeštoTreće' => '#']" />
            <content id="content" class="mt-2 px-1">
                ...
                <form method="POST" action="{{ route('material.store') }}">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" class="form-control @error('brand') border border-danger @enderror" id="exampleInputPassword1" value="{{ old('brand') }}" name="brand">
                    </div>

                    <div class="mb-2">
                        <label for="exampleInputEmail1" class="form-label mb-0">Vrsta materijala *</label>
                        <select class="form-select @error('finish_id') border border-danger @enderror" aria-label="Default select example"
                                name="finish_id">
                    ...
                    <div class="d-flex gap-2">
                        <div class="mb-2">
                            ...
                            <input type="number" class="form-control @error('width') border border-danger @enderror" id="exampleInputPassword1" value="{{ old('width') }}" name="width">
                        </div>
                        <div class="mb-2">
                            <label for="exampleInputPassword1" class="form-label mb-0">Dužina (smer tabaka) *</label>
                            <input type="number" class="form-control @error('length') border border-danger @enderror" id="exampleInputPassword1" value="{{ old('length') }}" name="length">
                        </div>
                    </div>

                    <div class="mb-2">
                        <label for="exampleInputPassword1" class="form-label mb-0">Naziv formata *</label>
                        <input type="text" class="form-control @error('dimension_name') border border-danger @enderror" id="exampleInputPassword1" value="{{ old('dimension_name') }}" name="dimension_name">
                    </div>

                    <div class="mb-2">
                        <label for="exampleInputPassword1" class="form-label mb-0">Gramatura *</label>
                        <input type="number" class="form-control @error('weight') border border-danger @enderror" id="exampleInputPassword1" value="{{ old('weight') }}" name="weight">
                    </div>

                    <div class="mb-2">
                        <label for="exampleInputPassword1" class="form-label mb-0">Debljina</label>
                        <input type="number" class="form-control @error('tickness') border border-danger @enderror" id="exampleInputPassword1" value="{{ old('tickness') }}" name="tickness">
                    </div>
