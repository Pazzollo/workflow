                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('reservation.update', $reservation) }}" method="post">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" class="form-control" id="quantity" value="{{ $reservation->quantity }}" name="quantity">
                        </div>

                        <div class="mb-2">
                            <label for="description" class="form-label mb-0">Opis (broj naloga ili razlog)*</label>
                            <input type="text" class="form-control @error('description') border border-danger @enderror" id="description" value="{{ $reservation->description }}" name="description">
                        </div>
